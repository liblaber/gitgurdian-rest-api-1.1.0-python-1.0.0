...
class HoneyTokenSource(BaseModel):
    ...
    :param open_issues_count: Number of open secret issues with at least one occurrence on this source. , defaults to None
    :type open_issues_count: float, optional
    :param total_files_count: Number of files where the honeytoken appears. , defaults to None
