...
class PolicyBreak(BaseModel):
    ...
    :param known_secret: Indicates whether the secret is known by your GitGuardian dashboard. , defaults to None
    :type known_secret: bool, optional
    :param incident_url: The incident's URL on your GitGuardian dashboard, if it is a known secret, or an empty string otherwise. , defaults to None
