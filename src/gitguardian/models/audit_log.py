...
class AuditLog(BaseModel):
    ...
    :param member_name: Name of the member at the time he/she did the event. It may differ from the current name of the member if it has been updated since. , defaults to None
    :type member_name: str, optional
    :param member_id: ID of the member that did the event. Can be null if the member has been deleted since then: in that case use `member_name` and `member_email` to identify the author of the action. , defaults to None
    :type member_id: int, optional
    :param api_token_id: ID of the API token associated to the event if it was done via the API. Can be null if the action was not performed via the API. , defaults to None
