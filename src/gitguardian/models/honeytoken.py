...
class Honeytoken(BaseModel):
    ...
    :param creator_api_token_id: ID of the API key which created this honeytoken. Can be null if the honeytoken was not created via the API. , defaults to None
    :type creator_api_token_id: str, optional
    :param revoker_api_token_id: ID of the API key which created honeytoken note. Can be null if the honeytoken was not created via the API. , defaults to None
