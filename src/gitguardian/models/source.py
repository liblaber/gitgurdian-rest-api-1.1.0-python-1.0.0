...
class Source(BaseModel):
    ...
    :param open_incidents_count: Number of open secret incidents with at least one occurrence on this source. , defaults to None
    :type open_incidents_count: int, optional
    :param closed_incidents_count: Number of closed secret incidents with at least one occurrence on this source. , defaults to None
    ...
    :param external_id: VCS identifier of the source (e.g.: the GitHub id for a GitHub repository). Warning: external_id is a string because some VCS ids can be UUIDs. , defaults to None
    :type external_id: str, optional
    :param source_criticality: Criticality of the source. , defaults to None
    :type source_criticality: str, optional
    :param last_scan: last_scan, defaults to None
    :type last_scan: Scan, optional
    :param monitored: Whether the source is currently monitored by GitGuardian. , defaults to None
